<template>
  <div
    class="max-w-md mt-20 h-full max-h-[780px] w-full p-8 bg-card shadow-lg rounded-lg border border-primary"
  >
    ...
    <p class="mt-4 text-center text-muted-foreground">
      ...
      <NuxtLink to="/login" class="text-accent hover:underline">Login</NuxtLink>
    </p>
  </div>
</template>
